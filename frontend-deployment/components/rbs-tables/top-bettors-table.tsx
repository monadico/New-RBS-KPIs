            ...
            {data.map((bettor, index) => (
              <TableRow
                ...
                className={cn(
                  ...
                  index === 0 && "bg-rbs-lime/10 hover:bg-rbs-lime/20",
                  index === 1 && "bg-rbs-accent/10 hover:bg-rbs-accent/20",
                  index === 2 && "bg-rbs-dark-lime/10 hover:bg-rbs-dark-lime/20",
                )}
              >
                ...
                <TableCell className="font-mono text-text-mono text-xs">
                  <span className="break-all">{bettor.user_address}</span>
                </TableCell>
